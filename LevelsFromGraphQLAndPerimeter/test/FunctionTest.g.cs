...
namespace LevelsFromGraphQLAndPerimeter.Tests
{
    public class FunctionTests
    {
        ...
        public async Task InvokeFunction()
        {
            ...
            var store = new FileModelStore<LevelsFromGraphQLAndPerimeterInputs>(root, true);

            // Create an input object with default values.
            var input = new LevelsFromGraphQLAndPerimeterInputs();
